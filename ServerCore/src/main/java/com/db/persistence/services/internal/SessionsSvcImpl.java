...
import com.db.persistence.objectStore.WorkSessionPrivateCache;
...
//	@Autowired
//	WorkSessionPrivateCache workSessionPrivateCache;
...
//		this.entityManager = workSession.getEntityManager();
	}
	...
	public void publish() {
		...
		workSession.publish(revisionManager.getNextRevision());
		workSession.flush();
...
//				continue;
//
//			logger.error("going to handle '" + clz + "' publishing");
//			handlePublishForType(clz, nextRevision);
//		}

		workSession.publish(nextRevision);
		workSession.flush();
	}
...
//		return entityManager.find(clz, key.getObjId());
//	}
...
//			entityManager.delete(publicItem);
//		}
//		else {
...
//
//		// Clean the private
//		entityManager.delete(privateItem);
//		logger.debug("Done");
//	}
//
...
//			entityManager.delete(objectDeref);
