...
//		QueryResponseRemote list = querySvcRemote.runNativeQuery("SELECT * FROM missionitems c WHERE c.type='com.dronedb.persistence.scheme.MissionItem.MissionItemType.Waypoint'", Waypoint.class);
