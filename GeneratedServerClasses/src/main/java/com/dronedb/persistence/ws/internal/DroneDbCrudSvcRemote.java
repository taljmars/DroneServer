 ...
 * 
 */
@WebService(name = "DroneDbCrudSvcRemote", targetNamespace = "http://apis.scheme.persistence.dronedb.com/")
...
public interface DroneDbCrudSvcRemote {
    ...
    @Action(input = "http://apis.scheme.persistence.dronedb.com/DroneDbCrudSvcRemote/CheckConnectionRequest", output = "http://apis.scheme.persistence.dronedb.com/DroneDbCrudSvcRemote/CheckConnectionResponse")
     ...
     * @param arg0
     * @return
     *     returns com.dronedb.persistence.scheme.apis.BaseObject
     */
    @WebMethod
    @WebResult(partName = "return")
