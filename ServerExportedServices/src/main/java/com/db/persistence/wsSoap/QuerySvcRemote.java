...
public interface QuerySvcRemote {
	...
	@WebMethod
	<T extends BaseObject> QueryResponseRemote runNativeQueryWithClass(@WebParam String queryString, @WebParam Class<T> clz) throws QueryRemoteException;

	@WebMethod
	<T extends BaseObject> QueryResponseRemote runNativeQuery(@WebParam String queryString) throws QueryRemoteException;
	
	@WebMethod
	<T extends BaseObject> QueryResponseRemote runNamedQuery(@WebParam String queryString, @WebParam Class<T> clz) throws QueryRemoteException;
