...
public class Constants {
    ...
    private static final String format =
            ...
            "SELECT objId, toRevision FROM %1 " +
    ...
    public static final String MISSION_QUERY_FROM_TIP_AND_PRIVATE_1 = String.format(format, "mission");

    public static final String BuildQuery_GET_FROM_TIP_AND_PRIVATE(String tableName) {
        String format =
                // Not in private sessions
                "(objId, toRevision) NOT IN ( " +
                "SELECT objId, toRevision FROM %1 " +
