 ...
 * generated in the com.dronedb.persistence.scheme package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryResponseRemote_QNAME = new QName("http://scheme.persistence.dronedb.com/", "queryResponseRemote");
    private final static QName _QueryRequestRemote_QNAME = new QName("http://scheme.persistence.dronedb.com/", "queryRequestRemote");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.dronedb.persistence.scheme
     * 
     */
    ...
    /**
     * Create an instance of {@link ObjectDeref }
     * 
     */
    public ObjectDeref createObjectDeref() {
        return new ObjectDeref();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://scheme.persistence.dronedb.com/", name = "queryResponseRemote")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://scheme.persistence.dronedb.com/", name = "queryRequestRemote")
